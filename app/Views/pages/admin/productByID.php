        ...
        <div class="w-2/3">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="rounded-lg">
                    ...
                    <img src="<?= base_url("uploads/product/" . esc($product['image'])) ?>" alt="Image of a <?= esc($product['name']) ?>" class="h-48 object-cover transition duration-500 group-hover:scale-105" />
